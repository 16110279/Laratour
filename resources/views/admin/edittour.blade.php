                  ...
                  <div class="form-group row">
                    ...
                    <div class="custom-file col-sm-6">
                        <div class="input-group date form-group" id="datepicker">
                            <input type="text" class="form-control" id="Dates" value="@foreach($date as $key => $scd) {{ $scd['date_start'] }},@endforeach" name="Dates" placeholder="Tanggal Keberangkatan" required />
 ...
 <div class="table-responsive">
               ...
               <tbody>
                 <tr>
                      ...
                      @php  $keyindex = 0; @endphp

                  @foreach ($tourprice as $key => $pricing)
                       
@php $keyindex++; @endphp

                 <td><input type="text" name="data[{{ $key }}][name]" value="{{$pricing->name}}" class="form-control" /></td>
        <td><input type="text" name="data[{{ $key }}][price]" value="{{$pricing->price}}" class="form-control" /></td>
        <td><button type="button" name="add" id="add" class="btn btn-success"><i class="fa fa-plus"></i></button>  &nbsp;&nbsp;
        <button type="button" name="remove" id="" class="btn btn-danger remove"><i class="fa fa-trash"></i></button></td></tr>
                   @endforeach
...
let statis = "{{$keyindex}}"
 ...
 dynamic_field(count, statis);

 function dynamic_field(number, statis)
 {
    html = '<tr>';
