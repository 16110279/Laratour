  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Zakaria Mursid</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="{{url('admin/')}}" class="nav-link <?php if($menu == 'Dashboard') { echo 'active'; } ?>">
            ...
            <li class="nav-item">
            <a href="{{url('/admin/destination')}}" class="nav-link <?php if($menu == 'Destination') { echo 'active'; } ?>">
            ...
            <li class="nav-item">
            <a href="{{url('/admin/tour')}}" class="nav-link <?php if($menu == 'Tours') { echo 'active'; } ?>">
