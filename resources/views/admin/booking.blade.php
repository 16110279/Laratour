            ...
            <div class="col-md-10">
             <input type="text" name="name" id="name" class="form-control" />
                  ...
                  <label class="col-sm-2 col-form-label">phone</label>
                      <div class="col-sm-10">
                                                {{-- <select class="form-control select2bs4" name="phone_id" id="phone" style="width: 100%;" data-placeholder="Select a phone"> --}}

                        <select class="form-control select2bs4" name="phone_id" id="phoneID" style="width: 100%;" data-placeholder="Select a phone">
                                                    <option value="" hidden></option>

                          @foreach ($booking as $ctr)
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   success:function(html){
    ...
    $('#phone').val(html.data.countries.name);
    // $("div.phone select").val(html.data.countries.name);
    // $("div.phone").val(html.data.countries.name).change();
      // $('div.phone  option[value=.'html.data.countries.name.']').prop("selected", true);
    $('#phoneID').val(html.data.countries.id).change();
